...
namedataset1 <- "D3_dispensings_AA"

# c("data","Nvialsday","year","month")


namedataset2 <- "D3_study_population"

# c("person_id","birth_date","gender","age","ageband","death_date","period","date_bleeding","event","end_followup_d","number_previous_bleedings","days_since_most_recent_bleeding")
